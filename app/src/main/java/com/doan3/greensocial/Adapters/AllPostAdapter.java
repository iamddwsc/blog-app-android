...
import com.doan3.greensocial.Activities.CommentActivity;
import com.doan3.greensocial.Activities.EditPostActivity;
...
public class AllPostAdapter extends RecyclerView.Adapter<AllPostAdapter.AllPostHolder>{
    ...
    @NonNull
    @Override
    public AllPostHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_post,parent,false);
        return new AllPostHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AllPostHolder holder, int position) {
    ...
    class AllPostHolder extends RecyclerView.ViewHolder{
        ...
        public AllPostHolder(@NonNull View itemView) {
            super(itemView);
