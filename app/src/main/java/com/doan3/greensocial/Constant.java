package com.doan3.greensocial;

public class Constant {
    public static final String URL =  "http://192.168.1.213/";
    ...
    public static final String STORIES = HOME+"/stories";
    public static final String ADD_STORY = STORIES+"/createStory";
}
